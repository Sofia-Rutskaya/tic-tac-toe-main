...
export class BotGameComponent implements OnInit, CanComponentDeactivate, OnDestroy {
  ...
  get won(): FormControl{
    return this.gameRes.get('won') as FormControl;
  }

  
  get draw(): FormControl{
    return this.gameRes.get('draw') as FormControl;
  }
  get loose(): FormControl{
    return this.gameRes.get('loose') as FormControl;
  }
